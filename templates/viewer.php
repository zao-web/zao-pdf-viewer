...
<head>
	...
	<?php if ( $css = apply_filters( 'zpdf_stylesheet', ZPDFV_URL . 'pdfjs/web/viewer.css' ) ) : ?>
		<link rel="stylesheet" href="<?php echo $css; ?>">
	<?php endif; ?>

	<!-- This snippet is used in production (included from viewer.html) -->
	<link rel="resource" type="application/l10n" href="<?php echo ZPDFV_URL . 'pdfjs/web/locale/locale.properties'; ?>">
	<script src="<?php echo apply_filters( 'zpdf_js', ZPDFV_URL . 'pdfjs/web/pdf.viewer.js' ); ?>"></script>
